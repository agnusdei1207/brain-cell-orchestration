...
- [x] risk classification now prefers the current step over the broader offensive objective, so reporting/documentation work is not auto-promoted to critical risk
